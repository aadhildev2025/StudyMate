    ...
    return (
        <div className="space-y-6">
            <Link to={`/subjects/${subjectId}`} className="inline-flex items-center text-gray-400 hover:text-white transition-colors">
                <ArrowLeft size={18} className="mr-2" /> Back to {subjectId}
            </Link>

            <div className="glass-card p-8 min-h-[60vh]">
                <div className="border-b border-white/10 pb-6 mb-6">
                    <h1 className="text-3xl font-bold text-white capitalize mb-2">{topicId}</h1>
                    <p className="text-gray-400">Subject: <span className="capitalize text-blue-400">{subjectId}</span></p>
                </div>
                ...
                {!content && !loading && (
                    <div className="text-center py-20 flex flex-col items-center">
                        ...
                        <h3 className="text-2xl font-bold text-white mb-3">AI Study Assistant</h3>
                        <p className="text-gray-400 mb-8 max-w-md">
                            Click below to generate comprehensive study notes, definitions, and exam tips for this topic instantly.
                        </p>
                        <button
                        ...
                        >
                            <Sparkles size={20} /> Generate Notes (Free)
                        </button>
                    </div>
                )}
                ...
                {loading && (
                    <div className="flex flex-col items-center justify-center py-24">
                        ...
                        <p className="font-medium text-blue-300 text-lg animate-pulse">Consulting the AI...</p>
                    </div>
                )}
                ...
                {content && (
                    <>
                        <div className="flex justify-end mb-4">
                            ...
                            >
                                <Sparkles size={16} /> Regenerate Answer
                            </button>
                        </div>
